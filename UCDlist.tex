...
\emph{meta.curation} changed to Q to allow combination as secondary term. The former usage \emph{meta.curation} for the id or name of a curator is discouraged. \emph{meta.id;metacuration} is recommended instead.
