...
It states that a successive versions of the UCD 1+ vocabulary are distributed in Endorsed notes within the IVOA.
This version is the first endorsed note for UCD list . 
It contains new UCD words discussed and accepted by the Semantics Working Group during the UCD list v1.4 RFM (request for modification)
available here \url{https://wiki.ivoa.net/twiki/bin/view/IVOA/UCDList_1-4_RFM }.
