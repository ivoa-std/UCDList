...
The last iteration on the list included new terms for planetary data and was published in a REC specification
\citep{2018ivoa.spec.0527M

It is maintained following advice from a UCD Scientific Board, 
and published as an Endorsed Note from version 1.4 onwards following the procedure defined in \citep{2019ivoa.spec.1007G} . 
