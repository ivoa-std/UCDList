...
\ucd stat.skewness \enducd, \ucd stat.kurtosis \enducd ,\enducd stat.mad \enducd \\
\ucd stat.percentile \enducd \\
\ucd meta.ref.pid \enducd, \ucd meta.ref.epic \enducd , \ucd meta.ref.rorid \enducd, \ucd meta.ref.orcid \enducd \\

\subsubsection*{Ammendment}
\ucd meta.curation \enducd changed to Q to allow combination as secondary term. The former usage \ucd meta.curation \enducd for the id or name of a curator is discouraged. \ucd meta.id;metacuration \enducd is recommended instead.
